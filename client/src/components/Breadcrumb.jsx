          ...
          return (
            <li key={index} className="flex items-center gap-1">
              ...
              {item.isEllipsis ? (
                // Ellipsis (non-link)
                <motion.span
                  className="text-[#888] hover:text-[#f5a623] transition-colors cursor-default px-1"
                ...
                <motion.span
                  className="text-[#888] font-medium truncate px-1 max-w-[150px] md:max-w-none"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                <Link
                  to={item.href}
                  className="text-[#888] hover:text-[#f5a623] transition-colors duration-200 truncate px-1 max-w-[150px] md:max-w-none"
                  style={{
                    color: 'inherit',
                    textDecoration: 'none',
                  }}
